...
exports.migrationDown = (name, sql) =>
  __awaiter(this, void 0, void 0, function*() {
    yield db.query(sql);
    yield db.query('DELETE FROM migrations WHERE name = $1', [name]);
  });
exports.getRecentMigrations = (limit = 1) =>
  __awaiter(this, void 0, void 0, function*() {
